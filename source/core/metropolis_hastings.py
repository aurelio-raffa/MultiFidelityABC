...
def metropolis_hastings(
    ...
    for iteration in range(number_of_samples):
        ...
        model.log_error_density.variance = variance_prev
...
def adaptive_multifidelity_mh(
    ...
    for iteration in range(max_iter):
        ...
        surrogate.log_error_density.variance = variance_prev
        high_fidelity.log_error_density.variance = variance_prev
        z_star = proposal.draw(z_prev)
