...
from scipy.stats import invgamma # non trovo questa variabile in chaospy
...
if __name__ == '__main__':
    ...
    hfm = HighFidelityModel(
        forward_model, data, x, l_e_d, log_prior)
    ...
    lfm = PCESurrogate(data, l_e_d, prior, log_prior, 2, 10)
    lfm.fit(hfm)
